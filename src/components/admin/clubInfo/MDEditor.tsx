...
const icons = {
  ...
  h4: (
    <svg width="43" height="24" viewBox="0 0 43 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M2.94987 0.704H6.09388V2.864H14.7819V0.704H17.9499V9.752H2.94987V0.704ZM6.09388 5.336V7.256H14.7819V5.336H6.09388ZM0.381875 11.648H20.4939V14.168H0.381875V11.648ZM8.82988 8.432H11.9979V12.704H8.82988V8.432ZM2.82988 19.184H18.2379V21.752H2.82988V19.184ZM2.82988 15.488H6.02188V20.144H2.82988V15.488ZM22.46 10.88H42.596V13.4H22.46V10.88ZM31.196 12.464H34.388V17.144H31.196V12.464ZM24.932 0.823999H40.028V9.104H24.932V0.823999ZM36.884 3.32H28.076V6.584H36.884V3.32ZM24.788 19.184H40.364V21.752H24.788V19.184ZM24.788 15.272H27.98V20.048H24.788V15.272Z"
        fill="#5A6379"
      />
    </svg>
  ),
